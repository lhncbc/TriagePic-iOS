/*
	...
	The implementation of properties and methods for the PLreservePatientIdsResponseType object.
	Generated by SudzC.com
*/
#import "PLreservePatientIdsResponseType.h"

@implementation PLreservePatientIdsResponseType
	...
	- (id) initWithNode: (CXMLNode*) node {
		...
		{
			self.idList = [Soap getNodeValue: node withName: @"idList"];
	...
	{
		return [self serialize: @"reservePatientIdsResponseType"];
	}
	...
	- (NSMutableString*) serializeElements
	{
		...
		if (self.idList != nil) [s appendFormat: @"<idList>%@</idList>", [CommonFunctions escapeForXML:self.idList]];
	...
	- (BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[PLreservePatientIdsResponseType class]]) {
