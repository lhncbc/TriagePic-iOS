...
@implementation PLgetEventListRequestType
	...
	{
		return [self serialize: @"getEventListRequestType"];
	}
	...
	- (BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[PLgetEventListRequestType class]]) {
