/*
	...
	The implementation of properties and methods for the PLappCheckResponseType object.
	Generated by SudzC.com
*/
#import "PLappCheckResponseType.h"

@implementation PLappCheckResponseType
	@synthesize url = _url;
	...
	{
		return [self serialize: @"appCheckResponseType"];
	}
	...
	- (NSMutableString*) serializeElements
	{
		...
		if (self.url != nil) [s appendFormat: @"<url>%@</url>", [CommonFunctions escapeForXML:self.url]];
		if (self.text != nil) [s appendFormat: @"<text>%@</text>", [CommonFunctions escapeForXML:self.text]];
	...
	- (BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[PLappCheckResponseType class]]) {
