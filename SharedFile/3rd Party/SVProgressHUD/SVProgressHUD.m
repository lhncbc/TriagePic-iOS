...
- (void)showProgress:(float)progress status:(NSString*)string maskType:(SVProgressHUDMaskType)hudMaskType {
    ...
    // Homemade gray out
    [[[UIApplication sharedApplication] windows][0] setTintAdjustmentMode:UIViewTintAdjustmentModeDimmed];
}
...
- (void)dismiss {
    ...
    //[self.overlayView.superview setTintAdjustmentMode:UIViewTintAdjustmentModeAutomatic];
